  ...
  ;(async () => {
    try {
      if (process.env.ENV === 'production') {
        console.log('[production] Started refreshing application (/) commands.')
        ...
        console.log('[test] Started refreshing application (/) commands.')
        ...
        console.log('[test] Successfully reloaded application (/) commands.')
      }
    } catch (error) {
      console.error(error)
    }
